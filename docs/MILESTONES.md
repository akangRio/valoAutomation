...
*Establish the central Express API Gateway, Prisma PostgreSQL database client, and BullMQ Redis queues.*
...
*Implement the local computer vision engine as an asynchronous queue worker.*
...
*Integrate Cloud AI visual synthesis and vocal synchronization.*
...
*Implement programmatic 9:16 portrait video editing and subtitle synchronization.*
...
*Automate YouTube uploads, credential rotations, and local disk space maintenance.*
